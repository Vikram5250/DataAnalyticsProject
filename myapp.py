...
if(file!=None):
    ...
    st.write('The group by lets you summarize data by specific categories and groups.')
    with st.expander('Group By your columns'):
        ...
        with col3:
            operation = st.selectbox('Choose operation',options=['sum','max','min','median','mean'])
    if(groupby_cols):
        ...
        st.subheader(':grey[Data Visualization]')
